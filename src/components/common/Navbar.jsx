        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="w-full max-w-md mx-4">
            {authMode === 'login' ? (
              ...
              // BUG FIX: was onSuccess={switchToLogin} -- see LandingPage.jsx
              // for the full explanation. Now reuses handleLoginSuccess,
              // which also navigates straight to the dashboard.
              <SignupModal
                onSuccess={handleLoginSuccess}
                onClose={closeAuthModal}
