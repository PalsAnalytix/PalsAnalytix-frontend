...
const CurriculumSection = () => {
  return (
    <section className="mb-12">
      <h2 className="font-sora text-2xl font-semibold text-charcoal mb-4">
        SCR® Exam Curriculum
      </h2>
      {/* Scrollable container */}
      <div
        className="bg-sand-100 border border-sand-200 p-4 rounded-lg overflow-y-auto"
      ...
      >
        ...
        <div className="space-y-6">
          <div className="p-4 bg-white border border-sand-200 rounded-lg">
            ...
            <p className="mt-2 text-sand-600">Exam Weight: 8 - 12 Questions</p>
            <ul className="list-disc mt-2 ml-6 text-sand-900">
              <li>
          ...
          <div className="p-4 bg-white border border-sand-200 rounded-lg">
            ...
            <p className="mt-2 text-sand-600">Exam Weight: 12 - 18 Questions</p>
            <ul className="list-disc mt-2 ml-6 text-sand-900">
          ...
          <div className="p-4 bg-white border border-sand-200 rounded-lg">
            <h3 className="font-sora text-xl font-semibold text-charcoal">8. Net Zero</h3>
            <p className="mt-2 text-sand-600">Exam Weight: 4 - 6 Questions</p>
            <ul className="list-disc mt-2 ml-6 text-sand-900">
              <li>
